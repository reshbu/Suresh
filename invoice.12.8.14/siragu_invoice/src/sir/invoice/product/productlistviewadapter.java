...
public class productlistviewadapter extends ArrayAdapter<prorowteam> {
   ...
   int i=0;
	 List<prorowteam> Cart = new ArrayList<prorowteam>();;
	     public productlistviewadapter(Context context,int resourceId,List<prorowteam> items, int j) 
    {
       ...
       LayoutInflater mInflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) 
        {
            ...
            holder.txtTitle = (TextView) convertView.findViewById(R.id.item_display_pdname);
			 holder.txtQty = (EditText) convertView.findViewById(R.id.item_display_ed_qty);
        ...
        holder.txtQty.setOnFocusChangeListener(new OnFocusChangeListener() {
            public void onFocusChange(View v, boolean hasFocus) {
               ...
               //     String searchString = holder.txtQty.getText().toString();
              		 rowItem.setquty(Integer.parseInt(Caption.getText().toString()));
